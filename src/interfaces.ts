type IRowData = { type: string, id: number, summary: string, status: string, ownedBy: string, techOwner: string, qaOwner: string, qaConfirmed: boolean, baConfirmed: boolean, wsConfirmed: boolean }
